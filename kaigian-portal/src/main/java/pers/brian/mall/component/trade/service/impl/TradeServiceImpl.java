...
import pers.brian.mall.component.trade.alipay.model.GoodsDetail;
...
import pers.brian.mall.component.trade.alipay.service.impl.AlipayTradeServiceImpl;
import pers.brian.mall.component.trade.alipay.utils.ZxingUtils;
...
public class TradeServiceImpl implements TradeService {
    ...
    private String aliPayTrade(OrderDetailDTO detail) {
        ...
        String subject = "KaiGian Mall当面付扫码消费";
        ...
        for (OmsOrderItem orderItem : detail.getOrderItemList()) {
            ...
            GoodsDetail tempGoods = GoodsDetail.newInstance(
